--
-- Type: TABLE; Owner: BIOMART; Name: BIO_ASSAY_ANALYSIS_DATA_JEA
--
 CREATE TABLE "BIOMART"."BIO_ASSAY_ANALYSIS_DATA_JEA" 
  (	"BIO_ASY_ANALYSIS_DATA_ID" NUMBER NOT NULL DISABLE, 
