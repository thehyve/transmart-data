...
--
  CREATE OR REPLACE FORCE VIEW "TM_CZ"."CZV_PIVOT_SAMPLE_CATEGORIES" ("TRIAL_CD", "SAMPLE_ID", "TRIAL_NAME", "PATHOLOGY", "RACE", "TISSUE_TYPE", "GENDER", "BIOMARKER", "ACCESS_TYPE", "INSTITUTION", "PROGRAM_INITIATIVE", "ORGANISM") AS 
  select x.trial_cd
