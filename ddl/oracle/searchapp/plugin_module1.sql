--
-- Type: TABLE; Owner: SEARCHAPP; Name: PLUGIN_MODULE1
--
...
--
ALTER TABLE "SEARCHAPP"."PLUGIN_MODULE1" ADD CONSTRAINT "PLUGIN_MODULE_PLUGIN_FK1" FOREIGN KEY ("PLUGIN_SEQ")
 REFERENCES "SEARCHAPP"."PLUGIN1" ("PLUGIN_SEQ") ENABLE;
