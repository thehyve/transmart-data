...
--
-- Type: INDEX; Owner: I2B2METADATA; Name: IDX_BIRN_B
--
...
--
-- Type: INDEX; Owner: I2B2METADATA; Name: IDX_BIRN_FULLNAME_BASECODE
--
CREATE INDEX "I2B2METADATA"."IDX_BIRN_FULLNAME_BASECODE" ON "I2B2METADATA"."BIRN" ("C_FULLNAME", "C_BASECODE")
TABLESPACE "USERS" ;

--
-- Type: INDEX; Owner: I2B2METADATA; Name: BIRN_IDX1
--
