--
-- Type: TABLE; Owner: I2B2METADATA; Name: SYS_IMPORT_TABLE_03
--
 CREATE TABLE "I2B2METADATA"."SYS_IMPORT_TABLE_03" 
...
LOB ("XML_CLOB") STORE AS BASICFILE (
 ...
 NOCACHE NOLOGGING ) ;
--
-- Type: INDEX; Owner: I2B2METADATA; Name: SYS_MTABLE_000012FBC_IND_2
--
CREATE INDEX "I2B2METADATA"."SYS_MTABLE_000012FBC_IND_2" ON "I2B2METADATA"."SYS_IMPORT_TABLE_03" ("BASE_PROCESS_ORDER")
TABLESPACE "USERS" ;
--
-- Type: INDEX; Owner: I2B2METADATA; Name: SYS_MTABLE_000012FBC_IND_3
--
CREATE INDEX "I2B2METADATA"."SYS_MTABLE_000012FBC_IND_3" ON "I2B2METADATA"."SYS_IMPORT_TABLE_03" ("OBJECT_PATH_SEQNO")
TABLESPACE "USERS" ;
--
-- Type: INDEX; Owner: I2B2METADATA; Name: SYS_MTABLE_000012FBC_IND_1
--
CREATE INDEX "I2B2METADATA"."SYS_MTABLE_000012FBC_IND_1" ON "I2B2METADATA"."SYS_IMPORT_TABLE_03" ("OBJECT_SCHEMA", "OBJECT_NAME", "OBJECT_TYPE")
TABLESPACE "USERS" ;
