--
-- Type: TABLE; Owner: I2B2METADATA; Name: ET$000D01230001
--
 CREATE TABLE "I2B2METADATA"."ET$000D01230001" 
...
"C_COMMENT" CLOB
  ...
  ORGANIZATION EXTERNAL 
   ( TYPE ORACLE_DATAPUMP
     ...
     ACCESS PARAMETERS
     ( DEBUG = (0 , 0) DATAPUMP INTERNAL TABLE "I2B2METADATA"."I2B2"  JOB ( "I2B2METADATA","SYS_IMPORT_TABLE_01",2) WORKERID 1 PARALLEL 1 VERSION '11.1.0.0.0' ENCRYPTPASSWORDISNULL  COMPRESSION DISABLED  ENCRYPTION DISABLED                     )
     LOCATION
      ( 'bogus.dat'
      )
   )
