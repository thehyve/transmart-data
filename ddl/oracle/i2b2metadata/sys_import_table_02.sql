--
-- Type: TABLE; Owner: I2B2METADATA; Name: SYS_IMPORT_TABLE_02
--
 CREATE TABLE "I2B2METADATA"."SYS_IMPORT_TABLE_02" 
...
--
-- Type: INDEX; Owner: I2B2METADATA; Name: SYS_MTABLE_000012F60_IND_2
--
CREATE INDEX "I2B2METADATA"."SYS_MTABLE_000012F60_IND_2" ON "I2B2METADATA"."SYS_IMPORT_TABLE_02" ("BASE_PROCESS_ORDER")
TABLESPACE "USERS" ;

--
-- Type: INDEX; Owner: I2B2METADATA; Name: SYS_MTABLE_000012F60_IND_1
--
CREATE INDEX "I2B2METADATA"."SYS_MTABLE_000012F60_IND_1" ON "I2B2METADATA"."SYS_IMPORT_TABLE_02" ("OBJECT_SCHEMA", "OBJECT_NAME", "OBJECT_TYPE")
TABLESPACE "USERS" ;

--
-- Type: INDEX; Owner: I2B2METADATA; Name: SYS_MTABLE_000012F60_IND_3
--
CREATE INDEX "I2B2METADATA"."SYS_MTABLE_000012F60_IND_3" ON "I2B2METADATA"."SYS_IMPORT_TABLE_02" ("OBJECT_PATH_SEQNO")
TABLESPACE "USERS" ;
