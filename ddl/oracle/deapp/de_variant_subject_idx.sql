...
--
-- Type: REF_CONSTRAINT; Owner: DEAPP; Name: SYS_C0045378
--
ALTER TABLE "DEAPP"."DE_VARIANT_SUBJECT_IDX" ADD FOREIGN KEY ("DATASET_ID")
...
--
-- Type: TRIGGER; Owner: DEAPP; Name: TRG_VARIANT_SUBJECT_IDX_ID
--
  CREATE OR REPLACE TRIGGER "DEAPP"."TRG_VARIANT_SUBJECT_IDX_ID" 
