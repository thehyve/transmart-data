--
-- Type: TABLE; Owner: DEAPP; Name: SYS_IMPORT_FULL_01
--
 CREATE TABLE "DEAPP"."SYS_IMPORT_FULL_01" 
...
--
-- Type: INDEX; Owner: DEAPP; Name: SYS_MTABLE_000018604_IND_3
--
CREATE INDEX "DEAPP"."SYS_MTABLE_000018604_IND_3" ON "DEAPP"."SYS_IMPORT_FULL_01" ("OBJECT_PATH_SEQNO")
TABLESPACE "USERS" ;

--
-- Type: INDEX; Owner: DEAPP; Name: SYS_MTABLE_000018604_IND_2
--
CREATE INDEX "DEAPP"."SYS_MTABLE_000018604_IND_2" ON "DEAPP"."SYS_IMPORT_FULL_01" ("BASE_PROCESS_ORDER")
TABLESPACE "USERS" ;

--
-- Type: INDEX; Owner: DEAPP; Name: SYS_MTABLE_000018604_IND_1
--
CREATE INDEX "DEAPP"."SYS_MTABLE_000018604_IND_1" ON "DEAPP"."SYS_IMPORT_FULL_01" ("OBJECT_SCHEMA", "OBJECT_NAME", "OBJECT_TYPE")
TABLESPACE "USERS" ;
