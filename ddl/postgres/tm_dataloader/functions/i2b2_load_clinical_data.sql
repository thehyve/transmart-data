--
-- Name: i2b2_load_clinical_data(character varying, character varying, character varying, character varying, character varying, numeric, character varying); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_load_clinical_data(trial_id character varying, top_node character varying, secure_study character varying DEFAULT 'N'::character varying, highlight_study character varying DEFAULT 'N'::character varying, alwayssetvisitname character varying DEFAULT 'N'::character varying, currentjobid numeric DEFAULT '-1'::integer, merge_mode character varying DEFAULT 'REPLACE'::character varying) RETURNS numeric
