--
-- Name: i2b2_rna_seq_annotation(character varying, numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_rna_seq_annotation(gpl_id character varying, currentjobid numeric DEFAULT NULL::numeric) RETURNS numeric
