--
-- Name: i2b2_load_annotation_deapp(numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_load_annotation_deapp(currentjobid numeric DEFAULT '-1'::integer) RETURNS numeric
