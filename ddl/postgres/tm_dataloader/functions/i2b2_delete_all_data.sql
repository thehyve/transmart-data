--
-- Name: i2b2_delete_all_data(character varying, character varying, numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_delete_all_data(trial_id character varying, path_string character varying, currentjobid numeric DEFAULT '-1'::integer) RETURNS numeric
