--
-- Name: i2b2_add_trial_nodes(character varying, character varying, text[], numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_add_trial_nodes(trialid character varying, trialpath character varying, paths text[], currentjobid numeric) RETURNS numeric
