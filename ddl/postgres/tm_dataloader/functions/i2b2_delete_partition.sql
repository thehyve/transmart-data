--
-- Name: i2b2_delete_partition(character varying, character varying, character varying, character varying, character varying, numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_delete_partition(trialid character varying, removed_platform character varying, partition_table_name character varying, partition_schema character varying, sourcecd character varying, currentjobid numeric) RETURNS integer
