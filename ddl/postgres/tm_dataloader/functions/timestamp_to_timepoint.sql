--
-- Name: timestamp_to_timepoint(character varying, character varying); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION timestamp_to_timepoint(timestamp_value character varying, baseline_value character varying) RETURNS character varying
