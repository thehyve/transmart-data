--
-- Name: i2b2_load_security_data(numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_load_security_data(currentjobid numeric DEFAULT '-1'::integer) RETURNS numeric
...
--
-- Name: i2b2_load_security_data(character varying, numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_load_security_data(sourcesystemcd character varying, currentjobid numeric DEFAULT '-1'::integer) RETURNS numeric
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
/*************************************************************************
* Copyright 2008-2012 Janssen Research & Development, LLC.
