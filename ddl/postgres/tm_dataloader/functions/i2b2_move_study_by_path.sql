--
-- Name: i2b2_move_study_by_path(character varying, character varying, character varying, numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_move_study_by_path(old_path_in character varying, new_path_in character varying, savesecurity character varying, currentjobid numeric DEFAULT '-1'::integer) RETURNS integer
