--
-- Name: i2b2_add_nodes(character varying, text[], numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_add_nodes(trialid character varying, new_paths text[], currentjobid numeric) RETURNS numeric
