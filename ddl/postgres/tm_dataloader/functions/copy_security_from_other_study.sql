--
-- Name: copy_security_from_other_study(character varying, character varying, numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION copy_security_from_other_study(studyid character varying, studyidfrom character varying, currentjobid numeric) RETURNS integer
