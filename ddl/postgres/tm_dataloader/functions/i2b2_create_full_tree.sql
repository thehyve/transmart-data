--
-- Name: i2b2_create_full_tree(character varying, numeric); Type: FUNCTION; Schema: tm_dataloader; Owner: -
--
CREATE FUNCTION i2b2_create_full_tree(path character varying, currentjobid numeric DEFAULT '-1'::integer) RETURNS numeric
